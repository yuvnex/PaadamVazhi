              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '50%',
                    background: c.color,
                    border: isSelected ? '2.5px solid #38bdf8' : c.color === '#ffffff' ? '2px solid #555' : '2px solid transparent',
                    cursor: 'pointer',
                    outline: 'none',
                    boxShadow: isSelected ? '0 0 0 2px rgba(56, 189, 248, 0.4)' : 'none',
            ...
            {PEN_TYPES.map((pt) => (
              <button
                ...
                style={{
                  ...
                  background: penType === pt.id ? 'rgba(56, 189, 248, 0.16)' : 'transparent',
                  border: penType === pt.id ? '1.5px solid #38bdf8' : '1.5px solid transparent',
                  borderRadius: '6px',
                  cursor: 'pointer',
                  outline: 'none',
                  transition: 'all 0.15s ease',
